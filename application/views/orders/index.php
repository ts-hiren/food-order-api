...
$this->load->view('orders/partials/order-nav', [
	'new_order_count' => $orders->count() + $assigned_order_count + $pickup_order_count + $shipped_order_count,
	'active_tab' => 'new'
]);
?>
<div class="content">
	...
	$this->load->view('orders/partials/new-order-nav', [
		'pending_order_count' => $orders->count(),
	...
	<form method="post" id="orderAction" action="<?= base_url('orders') ?>">
		<input type="hidden" name="order_status" value="assign">
