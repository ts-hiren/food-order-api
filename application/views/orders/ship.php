...
$this->load->view('orders/partials/order-nav', [
	'new_order_count' => $pending_order_count + $assigned_order_count + $pickup_order_count + $orders->count(),
	'active_tab' => 'new'
]);
?>
<div class="content">
	<nav class="navbar navbar-expand-sm mb-3 p-0">
		<ul class="navbar-nav">
			...
			<li class="nav-item bg-light border border-left-0 border-dark-alpha">
				<a class="nav-link" href="javascript:;" onclick="completeOrders()">Complete</a>
			</li>
			<li class="nav-item bg-light border border-left-0 border-dark-alpha">
...
<script type="text/javascript">
	...
	function completeOrders() {
		swal({
            title: 'Are you sure?',
            text: 'You are completing order(s)!',
            type: 'warning',
            showCancelButton: true,
